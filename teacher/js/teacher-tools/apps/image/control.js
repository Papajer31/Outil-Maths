    ...
    host.innerHTML = `
      <section class="tt-control-panel tt-control-panel-compact tt-image-control" aria-label="Contrôles du widget Image">
        ...
        <div class="tt-widget-action-bar" aria-label="Actions du widget">
          ...
          ${renderActionButton({ id: "ttImageZoomOut", label: "Zoom -", icon: "zoom_out", className: "tt-widget-action-btn", disabled: !(hasImage && canZoomOut) })}
          ${renderActionButton({ id: "ttImageCenter", label: "100 %", icon: "fit_screen", className: "tt-widget-action-btn", disabled: !hasImage })}
          ${renderActionButton({ id: "ttImageZoomIn", label: "Zoom +", icon: "zoom_in", className: "tt-widget-action-btn", disabled: !(hasImage && canZoomIn) })}
          ${hasImage ? renderActionButton({ id: "ttImageClear", label: "Retirer", icon: "delete", className: "tt-widget-action-btn is-danger" }) : ""}
        </div>
