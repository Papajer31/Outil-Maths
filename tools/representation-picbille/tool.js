...
const DEFAULT_INSTRUCTION = "Donne la réponse avec la représentation Picbille.";

export default defineTool("representation-picbille", "Représentation décimale — Picbille", {
  version: "1",
  description: "Travailler la représentation décimale avec le support Picbille.",
