...
import { createActivity as createDroiteNumeriqueCompleteActivity } from "./activity.js";
...
export default defineTool("droite-numerique-complete", "Repérage sur droite complète", {
  version: "1",
  ...
  createActivity(context = {}) {
    return createDroiteNumeriqueCompleteActivity({
      ...context,
      defaultInstruction: DEFAULT_INSTRUCTION,
      supportsCustomInstruction: true
    });
