...
function renderPicbilleSvg(state) {
  ...
  for (let boxIndex = 0; boxIndex < question.picbilleBoxCount; boxIndex++) {
    boxesSvg += renderPicbilleBox(boxIndex, highlightedValue, highlightAnimation, question.picbilleStartValue ?? 1);
  }
...
function renderPicbilleBox(boxIndex, highlightedValue, highlightAnimation = null, firstLabelValue = 1) {
