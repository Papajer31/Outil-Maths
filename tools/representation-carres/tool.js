...
const DEFAULT_INSTRUCTION = "Donne la réponse avec les carrés de numération.";

export default defineTool("representation-carres", "Représentation décimale — Carrés", {
  version: "1",
  description: "Travailler la représentation décimale avec les carrés de base 10.",
