...
const DEFAULT_INSTRUCTION = "La collection est-elle correcte ?";

export default defineTool("collection", "Collection", {
  version: "1",
  description: "Travailler le lien entre nombre et collection avec plusieurs modes de réponse simples.",
  tags: ["maths", "nombres", "collections", "quantite", "qcm", "file-numérique", "clavier", "projection"],
